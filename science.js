...
　　　　'根の先端近くには、（　　　）という細い毛のような部分がある。',  
       ...
       '地層に力がはたらいて、押し曲げられたものを（　　　）という。　※ひらがな3字＋漢字1字で答えてください。',       
       '遠く離れた地層が同時代にできたことを調べる際のよい目印となる層のことを（　　　）という。　※ひらがな2字＋漢字1字で答えてください。',
       ...
       '血液は赤血球、白血球、血小板などの固体の成分と、（　　　）という液体の成分からできている。　※漢字1字＋ひらがな3字で答えてください。',
       ...
       '神経系のうち、中枢神経から細かく枝分かれし、体のすみずみまでいき渡っている神経を（　　　）という。　※漢字1字＋ひらがな3字＋漢字2字で答えてください。',
       '末しょう神経のうち、感覚器官からの信号を脳やせきずいに伝える神経を（　　　）という。',       
       '末しょう神経のうち、脳やせきずいからの信号を筋肉へ伝える神経を（　　　）という。',
       '刺激に対して意識と関係なく起こる反応を（　　　）という。',
       'ヘビのように、背骨を持つ動物を（　　　）という。　※カタカナ4字＋漢字2字で答えてください。', //190
       'ムカデのように、背骨を持たない動物を（　　　）という。　※漢字1字＋カタカナ4字＋漢字2字で答えてください。',
       '雌が体外に卵を産む繁殖形態を（　　　）という。',
   ...
   Check.onclick=()=>{
       ...
       if(typeof Answer[1] === "undefined" ){
           ...
           answers.innerText='(1)'+Answer[1]+'　(2)'+Answer[2]+'　(3)'+Answer[3]+'　(4)'+Answer[4]+'　(5)'+Answer[5]+'　(6)'+Answer[6]+'　(7)'+Answer[7]+'　(8)'+Answer[8]+'　(9)'+Answer[9]+'　(10)'+Answer[10];
           ResultArea.appendChild(answers);
       }
    }//Check.onclick
